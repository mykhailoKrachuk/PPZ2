...
<script>
  // Prosta \"baza danych\" przesyłek z przykładowymi trasami
  const shipments = [
    { 
      id:'NPX66UW2GP', 
      status:'Utworzona', 
      date:'2025-10-24',
      route: [
        { status: 'Utworzona', label: 'Utworzona', date: '22-10-2025 10:12', location: 'Warszawa – nadanie paczki' }
      ]
    },
    { 
      id:'WX90PL0AA1', 
      ...
      date:'2025-10-20',
      route: [
        { status: 'Utworzona', label: 'Utworzona', date: '18-10-2025 09:05', location: 'Kraków – rejestracja przesyłki' },
    ...
    { 
      ...
      date:'2025-09-18',
      route: [
        { status: 'Utworzona', label: 'Utworzona', date: '15-09-2025 11:20', location: 'Poznań – utworzenie etykiety' },
    ...
    { 
      ...
      date:'2025-08-04',
      route: [
        { status: 'Utworzona', label: 'Utworzona', date: '01-08-2025 10:00', location: 'Warszawa – sklep internetowy' },
    ...
    { 
      ...
      date:'2025-10-18',
      route: [
        { status: 'Utworzona', label: 'Utworzona', date: '16-10-2025 12:48', location: 'Łódź – nadanie' },
